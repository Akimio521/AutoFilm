...
'''
def list_files(webdav_url, username, password, show_path, depth=None, path='', count=0):
    options = {
...
directory, files, count = list_files(args.webdav_url, args.username, args.password, args.show_path, depth=None, path='', count=0)
